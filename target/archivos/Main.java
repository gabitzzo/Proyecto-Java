...
public class Main{
    public static void main(String[] args) {
        ...
        List<String> lineas = FileHelper.readFile("datos.csv");
        List<String> lineasPrev = FileHelper.readFile("previsto.csv");

        // PREVISTO: Goles de los equipos
        int golesPrev1 = Integer.parseInt(lineasPrev.get(1).split(",")[1]); // Primera línea - segunda palabra
        int golesPrev2 = Integer.parseInt(lineasPrev.get(2).split(",")[1]); // Segunda línea - segunda palabra
